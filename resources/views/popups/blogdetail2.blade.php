        ...
        <div class="container max-w-6xl md:px-0 px-5">
            ...
            <div class="flex md:flex-row flex-col md:justify-between items-start gap-10 w-full">
                ...
                <div class="flex flex-col gap-20 justify-center items-center my-20">
                    ...
                    <h1 class="md:text-4xl text-3xl font-bold">@lang('public.cart2text')</h1>

                    <img class="w-96 h-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrOdsZkSoAV8YL9loXYtKcnnzk7PJqDlmIIHR7-6Qpfw&s" alt="i">
                    ...
                    <div class="flex flex-col gap-8 w-full">
                        ...
                        <div>
                            <button class="text-white px-5 py-4 text-sm bg-[#008000] hover:bg-[#356d2a] uppercase font-semibold">post comment</button>
                        </div>
                    </div>
                </div>
