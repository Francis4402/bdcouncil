<dialog id="blog_modal_1" class="modal">
    <div class="modal-box max-w-4xl">
      ...
      <div class="flex md:flex-row flex-col justify-center gap-4 items-start">
          ...
          <div>
              <h3 class="font-bold text-2xl">@lang('public.cart1text')</h3>
              <p class="text-[#a1a1a1]">@lang('public.projecttext1')</p>
              <p class="py-4 w-full">@lang('public.texttime1')</p>
  ...
  <dialog id="blog_modal_2" class="modal">
    <div class="modal-box max-w-4xl">
      <form method="dialog">
        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
      </form>
