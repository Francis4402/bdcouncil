...
@section('mainpage')
        ...
        <div class="container max-w-6xl lg:px-0 px-5">
            ...
            <div class="flex md:flex-row flex-col md:justify-between items-start gap-10">
                <div class="flex flex-col gap-5">
                    <div class="flex md:flex-row flex-col items-center gap-5 justify-end">
                        <ul class="flex items-center gap-2 border rounded-lg p-1">
                            <li class="hover:bg-gray-200 px-5 py-1 rounded-md cursor-pointer">@lang('public.newest')</li>
                            <li class="hover:bg-gray-200 px-5 py-1 rounded-md cursor-pointer">@lang('public.unanswered')</li>
                        </ul>

                        <button class="flex items-center gap-2 border border-blue-600 hover:bg-blue-200 rounded-md px-5 py-[0.4rem] filter-btn">
                    ...
                    <div class="hidden filter">
                        @include('filterdropdown.filterdropdown')
    ...
    <script src="{{ mix('js/filterdropdown.js') }}"></script>
@endsection